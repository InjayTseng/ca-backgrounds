...
export const STR = {
  en: {
    ...
    siteTitle: 'Living Backgrounds',
    tablist: 'specimens',
    keys: '1–{n} switch · H hide UI · R reseed · Space pause · T theme · L language',
    speed: 'speed',
    dark: '☾ dark',
    light: '☀ light',
    reseed: 'reseed',
    ...
    langBtn: '中',
    langBtnLabel: '切換為中文',
    lostContext: 'The GPU dropped this canvas. Press play or switch tabs to rebuild it.',
  ...
  zh: {
    ...
    siteTitle: '會動的背景標本室',
    tablist: '標本',
    keys: '1–{n} 切換 · H 藏 UI · R 重播種 · Space 暫停 · T 主題 · L 語言',
    speed: '速度',
    dark: '☾ 深色',
    light: '☀ 淺色',
    reseed: '重播種',
    ...
    lostContext: 'GPU 收回了這張畫布，按播放或切換分頁即可重建。',
